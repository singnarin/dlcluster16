...
@section('content')
<center><h4>ข้อมูล electricity</h4></center>
<div align="center">
<div class="form-group">
  {!! Form::open(array('url' => 'schoolelectricitysearch', 'class' => 'form-inline')) !!}
    ...
    {!! Form::close( ) !!}<br />
    {!! Form::open(array('url' => 'schoolelectricitysearchp', 'class' => 'form-inline')) !!}
    <div class="input-group">
